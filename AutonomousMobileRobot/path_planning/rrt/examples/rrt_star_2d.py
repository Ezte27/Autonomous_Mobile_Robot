...
def main(X, Q, x_init, x_goal, max_samples, r, prc, rewire_count, obstacles):
    """
    ...
    print("Starting RRT Star...")
    start_time = time.perf_counter()
    solution = rrt.rrt_star(pygame_draw=True, obstacles=obstacles)
    print("Finished RRT Star in", round(time.perf_counter() - start_time, 6), "seconds")

    # Pygame setup
    pygame.init()

    screen = pygame.display.set_mode((screen_width, screen_height))
    pygame.display.set_caption("RRT Star 2D Example")
...
if __name__ == "__main__":
    ...
    main(X, Q, x_init, x_goal, max_samples, r, prc, rewire_count, obstacles)