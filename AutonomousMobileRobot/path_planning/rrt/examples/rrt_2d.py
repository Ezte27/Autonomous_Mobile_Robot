...
from AutonomousMobileRobot.path_planning.rrt.rrt import RRT
...
def main(X, Q, x_init, x_goal, max_samples, r, prc, obstacles):
    """
    ...
    solution = rrt.rrt_search(pygame_draw=True, obstacles=obstacles)
    print("Finished RRT in", round(time.perf_counter() - start_time, 6), "seconds")

    # Pygame setup
    pygame.init()

    screen = pygame.display.set_mode((screen_width, screen_height))
    pygame.display.set_caption("RRT 2D Example")
...
if __name__ == "__main__":
    ...
    main(X, Q, x_init, x_goal, max_samples, r, prc, obstacles)